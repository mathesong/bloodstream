...
bloodstream provides Docker and Apptainer container images that bundle all dependencies. Both use the same command-line arguments and produce identical results.
