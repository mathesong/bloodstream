            ...
            conditionalPanel(
              ...
              selectInput(inputId = "aif_weightscheme",
                          ...
                          choices = list("Uniform weighting" = 1,
                                         ...
                                         "abs(activity) weighting" = 3,
                                         "1/abs(activity) weighting" = 4),
                          selected = 2,
                          multiple = FALSE),
              div(p(glue::glue("Scheme 3 (abs(activity)) makes weights rise with activity, emphasising the peak. ",
                         "Scheme 4 (1/abs(activity)) makes weights fall with activity, the variance-stabilising ",
                         "direction for Poisson-like noise.")),
