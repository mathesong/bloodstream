...
#| echo: false
#| eval: !expr config$Model$AIF$Method != "Interpolation"
...
**Weighting Configuration:** `r weight_scheme_text` with Method weights: `r method_weights_display` and Taper weights: `r taper_weights_display`.
