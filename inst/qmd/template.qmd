...
```{r pf-modelcompare-description, eval=choose_best_model, echo=false}
#| results: asis
...
```{r, eval=parametric_pf, echo=false}
#| results: asis
...
```{r, eval=parametric_bpr, echo=false}
#| results: asis
...
```{r, eval=parametric_aif, echo=false}
#| results: asis
...
```{r, eval=final_plotting, echo=false}
#| results: asis
