...
```{r merge-runs, echo=merge_runs_config}
...
```{r merged-runs-table, echo=FALSE, eval=merged_any}
bidsdata %>%
...
```{r aif-rise-info, echo=FALSE, eval=do_triexp}
#| results: asis
